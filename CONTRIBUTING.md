...
Use Node 22+ and Git. There are no dependencies to install. Run `npm test` and
...
Keep the interface compact and readable, in both themes. Check changed surfaces
at 1440×900, 1280×800 and phone widths, with no console errors. Every metric needs a source, scope, and definition; unknown is not
