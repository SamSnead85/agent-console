...
const PROJECTS = {
  "demo-muster": { label: "Muster", path: "demo/muster" },
  "demo-atlas-checkout": {
...
const SESSION_NAMES = new Map([
  ["demo-muster|demo-claude-console-0001", "Muster"],
...
function progressOf() {
  ...
  return {
    ...
    percent: 72,
    summary:
      "Core coordination and console restoration are complete; portability evidence remains.",
    remaining: [
