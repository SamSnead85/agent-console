 ...
 *
 * Source: Anthropic published API pricing, verified 2026-09-20.
 * Cache multipliers are the published ratios: 5-minute writes 1.25x input,
 * 1-hour writes 2.00x input, reads 0.10x input except explicit model rates.
 *
...
export const PRICE_TABLE_DATE = "2026-09-20";
...
export const PRICES = {
  ...
  // 5.1 cache reads are $0.25/MTok, not the $1/MTok of 5.
  "claude-fable-5-1": [{ from: null, input: 10.0, output: 50.0, cacheRead: 0.25 }],
  "claude-mythos-5-1": [{ from: null, input: 10.0, output: 50.0, cacheRead: 0.25 }],
  ...
  // Verified 2026-09-22 on the same page. Cache hits are 0.05x input ($0.20/MTok).
  "claude-opus-5-5": [{ from: null, input: 4.0, output: 20.0, cacheRead: 0.2 }],
...
export function costSplit(model, t, day) {
  ...
  return {
    ...
    cw:
      ...
      1e6,
    cr: ((t.cr || 0) * (p.cacheRead ?? p.input * CACHE_READ_MULT)) / 1e6,
  };
}
