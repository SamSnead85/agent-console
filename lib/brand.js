 ...
 *
 * Agent Console, by LockedIn Labs. The console began life inside the Muster
 * CLI as "Muster Console"; it is a standalone product now and needs no fleet,
 * ledger or Git repository, so the old name is gone. The terminal banners and
 * help text read the name from here, and the tests read it from here rather
 * than from a literal, so nothing drifts.
 *
