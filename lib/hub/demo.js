/**
 * The demonstration fleet: five synthetic machines, three people, nine lanes.
 *
...
export const DEMO_DEVICES = [
  { id: "dev_demo_studio", label: "Studio", person: "You", local: true, joinedDaysAgo: 21 },
  { id: "dev_demo_laptop", label: "Laptop", person: "You", joinedDaysAgo: 12 },
  { id: "dev_demo_workstation", label: "Workstation", person: "Platform engineer", joinedDaysAgo: 9 },
  { id: "dev_demo_buildbox", label: "Build box", person: "Platform engineer", joinedDaysAgo: 9, silentMinutes: 38 },
  { id: "dev_demo_design", label: "Design laptop", person: "Design engineer", joinedDaysAgo: 3 },
];

/* rate: messages per minute at full tilt. idleMinutes: the lane last worked that long ago. */
const LANES = [
  { device: "dev_demo_studio", project: "atlas-api", branch: "main", tool: "claude-code", model: "claude-opus-5", rate: 7.5, agents: 3, agentModel: "claude-haiku-4-5-20251001" },
 ...
 * and a stop function.
 */
export function startDemo({ registry, store, now = () => Date.now(), tickMs = 1000 }) {
  ...
  return { names, stop: () => clearInterval(timer) };
}
